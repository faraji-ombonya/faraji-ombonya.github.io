                ...
                <div class="flex flex-col gap-16">
                  <article class="group relative flex flex-col items-start">
                    <h2 class="text-base font-semibold tracking-tight text-zinc-800 ">
                      ...
                      <a
                        target="_blank"
                        href="https://faraji-ombonya.github.io/blog/#/how-i-built-a-library-search-engine-powered-by-vector-search"
                      >
                        <span class="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                        <span class="relative z-10">
                          How I Built a Library Search Engine Powered by Vector
                          Search
                        </span>
                      </a>
                    </h2>
                    ...
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 ">
                      Keyword search sometimes is not enough. Sometimes you want
                      to search based on meaning. This is where vector search
                      comes in. In this article, I want to take you through how
                      I built a Library Search Engine that is powered by vector
                      search.
                    </p>
