                    ...
                    <article class="md:grid md:grid-cols-4 md:items-baseline">
                      <div class="md:col-span-3 group relative flex flex-col items-start">
                        <h2 class="text-base font-semibold tracking-tight text-zinc-800 ">
                          ...
                          >
                            ...
                            <span class="relative z-10">
                              How I Deployed my React Application with GitHub
                              Pages
                            </span>
                          </a>
                        </h2>
                        ...
                        <p class="relative z-10 mt-2 text-sm text-zinc-600 ">
                          ...
                          deployment options I had were Vercel, s3 site on AWS
                          and github pages. I decided to go with github pages
                          because it was free and also simple to deploy. GitHub
                          Pages also had simple CI/CD already integrated. This
                          meant that after a successful setup, all I needed to
                          do was push to production and my application would be
                          deployed.
                        </p>
                        <div
                          aria-hidden="true"
